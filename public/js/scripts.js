...
! function(e) {
    ...
    function r() {
        e("body").addClass(o), e("html").attr("dir", o);
        e("body").addClass(a), e("body").dore();
    }
    "undefined" != typeof Storage && (localStorage.getItem("dore-theme") ? t = localStorage.getItem("dore-theme") : localStorage.setItem("dore-theme", t), localStorage.getItem("dore-direction") ? o = localStorage.getItem("dore-direction") : localStorage.setItem("dore-direction", o), localStorage.getItem("dore-radius") ? a = localStorage.getItem("dore-radius") : localStorage.setItem("dore-radius", a));
    ...
    //     "undefined" != typeof Storage && (localStorage.setItem("dore-theme", o), window.location.reload())
    // }));
    // e("input[name='directionRadio']").on("change", (function(t) {
    //     var o = e(t.currentTarget).data("direction");
    //     "undefined" != typeof Storage && (localStorage.setItem("dore-direction", o), window.location.reload())
    // }));
    // e("input[name='radiusRadio']").on("change", (function(t) {
    //     var o = e(t.currentTarget).data("radius");
    //     "undefined" != typeof Storage && (localStorage.setItem("dore-radius", o), window.location.reload())
    // }));
    // e("#switchDark").on("change", (function(o) {
    //     var a = e(o.currentTarget)[0].checked ? "dark" : "light";
    //     "dark" == a ? t = t.replace("light", "dark") : "light" == a && (t = t.replace("dark", "light")), "undefined" != typeof Storage && (localStorage.setItem("dore-theme", t), window.location.reload())
    // }));
