...
function(e) {
    ...
    var o, i = !1;
    ! function() {
        Ce = Ce || {}, n.settings = $.extend({}, a, Ce), "undefined" != typeof Storage && (localStorage.getItem("dore-direction") && (o = localStorage.getItem("dore-direction")), i = "rtl" == o && !0);
        ...
        function x(e, t, a) {
            ...
            if (0 != n.length) {
                a = a || S();
                if (0 == $(".sub-menu ul[data-link='" + a + "']").length && (2 == v || t) && $(window).outerWidth() >= 768 && B("menu-default")) return t ? ($("#app-container").removeClass(k), $("#app-container").addClass("menu-default menu-sub-hidden sub-hidden"), v = 1) : ($("#app-container").removeClass(k), $("#app-container").addClass("menu-default main-hidden menu-sub-hidden sub-hidden"), v = 0), void A();
        ...
        $(".menu-button").on("click", (function(e) {
            ...
            if (!($(e.target).parents().hasClass("menu-button") || $(e.target).hasClass("menu-button") || $(e.target).parents().hasClass("sidebar") || $(e.target).hasClass("sidebar"))) {
                ...
                else $("#app-container").hasClass("menu-main-hidden") && $("#app-container").hasClass("menu-mobile") ? x(0) : ($("#app-container").hasClass("menu-hidden") || $("#app-container").hasClass("menu-mobile")) && x(0)
            }
        }));
        var W = "";
        ...
        $('body').ready(function (){
            var session = $('#flash_msg').html();
            if(session != null){
                var t, a, n;
                t = 'top', a = 'right', n = $('#flash_type').html(), $.notify({
                    title: $('#flash_title').html() || '',
                    message: $('#flash_msg').html(),
                    target: "_blank"
                }, {
                    element: "body",
                    position: null,
