        ...
        <div class="header-icons d-inline-block align-middle">
            ...
            <div class="position-relative d-none d-sm-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right mt-3 position-absolute" id="iconMenuDropdown">
                    <a href="#" class="icon-menu-item"><i class="iconsminds-equalizer d-block"></i>
                        <span>Settings</span>
                    </a>
...
<div class="menu">
    <div class="main-menu">
        <div class="scroll">
            <ul class="list-unstyled">
                <li class="active"><a href="{{route('admin.dashboard')}}"><i class="iconsminds-shop-4"></i> <span>Dashboards</span></a></li>
    ...
    <div class="sub-menu">
        <div class="scroll">
            {{-- <ul class="list-unstyled" data-link="security" id="security">
                <li>
                    <a href="Dashboard.Default.html"><i class="simple-icon-rocket"></i>
                        <span class="d-inline-block">IP Firewall</span>
                    </a>
                </li>
                <li>
                    <a href="Dashboard.Analytics.html"><i class="simple-icon-pie-chart"></i>
                        <span class="d-inline-block">Banned Users</span>
                    </a>
                </li>
                <li>
            ...
            <ul class="list-unstyled" data-link="invoice" id="invoice">
                <li>
                    <a href="{{route('admin.invoice')}}"><i class="iconsminds-receipt-4"></i>
                        <span class="d-inline-block">Invoices</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('admin.templates')}}"><i class="iconsminds-quill-3"></i>
                        <span class="d-inline-block">Templates</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('admin.escrow')}}"><i class="iconsminds-network"></i>
                        <span class="d-inline-block">Escrow</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('admin.disputes')}}"><i class="iconsminds-handshake"></i>
                        <span class="d-inline-block">Disputes</span>
                    </a>
                </li>
            </ul>
            {{-- <ul class="list-unstyled" data-link="invoice" id="invoice">
            ...
            {{-- <ul class="list-unstyled" data-link="dispute" id="dispute">
                <li>
